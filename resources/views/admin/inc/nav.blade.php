          ...
          <li class="nav-item dropdown user-menu">
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
              ...
              <li class="user-header text-bg-primary">
                ...
                @if($profile && $profile->image)
                  <img src="{{ asset('storage/' . $profile->image) }}" width="100" class="rounded-circle shadow" alt="{{ Auth::user()->name }}">
                @else
                  <img src="{{ asset('admin/img/user2-160x160.jpg') }}" width="100" class="rounded-circle shadow" alt="{{ Auth::user()->name }}">
                @endif
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="#" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Salon</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
            ...
            <ul
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('admin.salons.index') }}" class="nav-link">
